 ...
 */
exports.getStoptimesBasic = async (query = {}, projection = '-_id', options = {lean: true, sort: {stop_sequence: 1}, timeout: true}) => {
  ...
  return StopTime.find(stoptimeQuery, projection, options).sort({stop_id: 1});
};
